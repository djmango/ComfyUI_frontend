...
import { et as script$1, it as useToast, x as script } from "./vendor-primevue-DUHRgx0Y.js";
import { A as computed, Bt as unref, Gt as toDisplayString, Ht as normalizeClass, M as createBlock, N as createCommentVNode, P as createElementBlock, Q as onBeforeUnmount, R as createTextVNode, T as Fragment, V as defineComponent, at as renderList, bt as withCtx, ct as resolveDirective, et as onMounted, f as storeToRefs, j as createBaseVNode, jt as ref, rt as openBlock, xt as withDirectives, z as createVNode } from "./vendor-vue-core-lEb6pQ7x.js";
import { Ci as StatusBadge_default, Hi as useSubscriptionDialog, Ki as useTeamWorkspaceStore, Q as useBillingOperationStore, Vi as useBillingContext, Z as useDialogService, aa as TIER_TO_KEY, ca as getTierPrice, oa as getTierCredits, ra as DEFAULT_TIER_KEY } from "./promotionUtils-RbTs6TVG.js";
...
var SubscriptionPanelContentWorkspace_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const { isActiveSubscription, isFreeTier: isFreeTierPlan, subscription, showSubscriptionDialog, manageSubscription, fetchStatus, fetchBalance, getMaxSeats, resubscribe } = useBillingContext();
...
}), [["__scopeId", "data-v-63d7e1cc"]]);
//#endregion
export { SubscriptionPanelContentWorkspace_default as t };

//# sourceMappingURL=SubscriptionPanelContentWorkspace-wTyGBOqK.js.map