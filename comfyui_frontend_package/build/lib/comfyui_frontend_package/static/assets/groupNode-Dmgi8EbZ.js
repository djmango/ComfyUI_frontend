...
import { V as toolkit } from "./vendor-other-DBdmkK1j.js";
import { Bn as useWidgetStore, D as deserialiseAndCreate, E as DraggableList, G as $el, Ga as ExecutableNodeDTO, H as useExecutionStore, Hn as addValueControlWidgets, Jn as createAssetWidget, M as lcm, O as serialise, R as GROUP, S as app, Un as isValidWidgetType, Va as LiteGraph, Vn as ComfyWidgets, Z as useDialogService, Zr as assetService, ao as NodeSlot, br as GET_CONFIG, ei as useNodeDefStore, eo as LGraphNode, q as ComfyDialog, va as applyTextReplacements, wa as useChainCallback, yr as CONFIG } from "./promotionUtils-RbTs6TVG.js";
import { c as t } from "./i18n-CKSCRJIF.js";
import { C as isIntInputSpec, S as isFloatInputSpec, _ as getComboSpecComboOptions, r as api, v as getInputSpecType, y as isComboInputSpec } from "./api-nNRZeCUN.js";
...
var ManageGroupDialog = class extends ComfyDialog {
	...
	show(groupNodeType) {
		...
		this.tabs = tabEntries.reduce((p, [name, page]) => {
			p[name] = {
				tab: $el("a", {
					onclick: () => {
						this.changeTab(name);
...
var ext = {
	...
	getCanvasMenuItems(canvas) {
		...
		return [{
			...
			disabled: !groups || !Object.keys(groups).length,
...
//#endregion
export { setWidgetConfig as a, mergeIfValid as i, GroupNodeHandler as n, applyFirstWidgetValueToGraph as o, getWidgetConfig as r, GroupNodeConfig as t };

//# sourceMappingURL=groupNode-Dmgi8EbZ.js.map