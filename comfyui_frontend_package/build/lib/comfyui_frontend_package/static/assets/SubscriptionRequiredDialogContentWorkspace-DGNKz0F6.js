...
import { G as script$1, it as useToast, v as script } from "./vendor-primevue-DUHRgx0Y.js";
...
import { Q as useBillingOperationStore, Vi as useBillingContext, Zi as getComfyPlatformBaseUrl, aa as TIER_TO_KEY, ca as getTierPrice, ia as TIER_PRICING, oa as getTierCredits, sa as getTierFeatures } from "./promotionUtils-RbTs6TVG.js";
...
function useSubscriptionCheckout(emit) {
	const { t } = useI18n();
...
var SubscriptionRequiredDialogContentWorkspace_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	emits: ["close"],
	setup(__props, { emit: __emit }) {
		const { checkoutStep, isLoadingPreview, loadingTier, isSubscribing, isResubscribing, previewData, selectedTierKey, selectedBillingCycle, isPolling, handleSubscribeClick, handleBackToPricing, handleAddCreditCard, handleConfirmTransition, handleResubscribe } = useSubscriptionCheckout(__emit);
		return (_ctx, _cache) => {
			const _component_i18n_t = resolveComponent("i18n-t");
			return openBlock(), createElementBlock("div", _hoisted_1, [
				...
				__props.reason === "out_of_credits" ? (openBlock(), createElementBlock("div", _hoisted_4, [createBaseVNode("h2", _hoisted_5, toDisplayString(_ctx.$t("credits.topUp.insufficientTitle")), 1), createBaseVNode("p", _hoisted_6, toDisplayString(_ctx.$t("credits.topUp.insufficientMessage")), 1)])) : createCommentVNode("", true),
...
}), [["__scopeId", "data-v-026b5e05"]]);
//#endregion
export { SubscriptionRequiredDialogContentWorkspace_default as default };

//# sourceMappingURL=SubscriptionRequiredDialogContentWorkspace-DGNKz0F6.js.map