const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./i18n-gRcGXabE.js","./i18n-CKSCRJIF.js","./rolldown-runtime-w0pxe0c8.js","./vendor-primevue-DUHRgx0Y.js","./vendor-vue-core-lEb6pQ7x.js","./vendor-i18n-DqMDtj1Y.js","./commands-CNd8pb7g.js","./main-CpnoxeA3.js","./nodeDefs-Bl2vpgyY.js","./settings-SBB4ueng.js"])))=>i.map(i=>d[i]);
import { a as __toESM, r as __name } from "./rolldown-runtime-w0pxe0c8.js";
import { D as script, G as script$3, Q as script$1, S as script$2, et as script$5, tt as __vitePreload, w as script$4 } from "./vendor-primevue-DUHRgx0Y.js";
import { A as computed, At as readonly, Bt as unref, C as withModifiers, Et as isRef, Gt as toDisplayString, H as getCurrentInstance, Ht as normalizeClass, It as toRef, J as mergeModels, K as inject, M as createBlock, N as createCommentVNode, P as createElementBlock, Pt as shallowRef, Q as onBeforeUnmount, R as createTextVNode, Rt as toValue, S as withKeys, T as Fragment, V as defineComponent, Wt as normalizeStyle, X as nextTick, _t as watchEffect, at as renderList, bt as withCtx, ct as resolveDirective, et as onMounted, f as storeToRefs, ft as useId, gt as watch, it as provide, j as createBaseVNode, jt as ref, ot as renderSlot, pt as useModel, rt as openBlock, tt as onUnmounted, u as defineStore, v as useCssVars, x as vShow, xt as withDirectives, z as createVNode } from "./vendor-vue-core-lEb6pQ7x.js";
import { $ as memoize, J as omit, K as isEmpty, N as require_semver, Y as merge, _t as flatMap, at as some, bt as filter, d as liteClient, et as debounce, f as v4, ft as partition, ht as groupBy, k as require_quick_lru, ot as isNil, pt as orderBy, q as pickBy, rt as uniqBy, vt as map, yt as find } from "./vendor-other-DBdmkK1j.js";
import { Ao as mapAllNodes, Di as usePrimeVueOverlayChildStyle, Ii as useColorPaletteStore, J as useSettingsDialog, Ji as useAuthStore, S as app, Si as LeftSidePanel_default, Ti as SingleSelect_default, Z as useDialogService, _a as useSettingStore, _r as searchInputVariants, ci as transformInputSpecV1ToV2, da as useCommandStore, ei as useNodeDefStore, go as collectAllNodes, gr as searchInputSizeConfig, gt as normalizePackKeys, ha as NoResultsPlaceholder_default, ht as normalizePackId, jo as isAbortError, lr as PropertiesAccordionItem_default, pi as VirtualGrid_default, rr as ModelInfoField_default, vt as NodePreview_default, wi as BaseModalLayout_default, y as useWorkflowStore } from "./promotionUtils-RbTs6TVG.js";
import { t as isCloud } from "./types-LUZjNlbK.js";
import { $ as until, B as useStorage, G as get, W as createSharedComposable, at as watchDebounced, b as useEventListener, ot as whenever, u as useAsyncState } from "./vendor-vueuse-B9Hj6YrL.js";
...
import { C as isValidUrl, O as paramsToCacheKey } from "./formatUtil-DYCY4wm_.js";
import { bt as ComboboxAnchor_default, ct as ComboboxPortal_default, dt as ComboboxInput_default, mt as ComboboxRoot_default, pt as ComboboxContent_default, ut as ComboboxItem_default } from "./vendor-reka-ui-DQClbqQd.js";
...
import { n as useSystemStatsStore, r as useCopyToClipboard } from "./extensionStore-DLGBp7MW.js";
...
import { t as toError } from "./errorUtil-CeVwjeWE.js";
...
var useBootstrapStore = defineStore("bootstrap", () => {
	...
	const { isReady: isI18nReady, error: i18nError, execute: loadI18n } = useAsyncState(async () => {
		const { mergeCustomNodesI18n } = await __vitePreload(async () => {
			const { mergeCustomNodesI18n } = await import("./i18n-gRcGXabE.js");
...
//# sourceMappingURL=useConflictDetection-oEMPXr1B.js.map